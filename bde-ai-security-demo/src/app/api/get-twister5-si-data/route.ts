...
async function fetch_mnd_SecurityLogs(): Promise<FetchResult> {
...
export async function POST(request: Request): Promise<Response> {
  try {
    const result: FetchResult = await fetch_mnd_SecurityLogs();
...
// 初始調用和定時執行
fetch_mnd_SecurityLogs().then((result: FetchResult) =>
